...
void loop(void)
{
    ...
    {/*/
        ...
        /***/
        ps2::UsbKeyAction usbCode = usbMapping.translatePs2Keycode(scanCode);
...
void sendScanCode(ps2::UsbKeyAction usbCode){
    ...
    if(usbCode.gesture == 1){
      ...
      if(pressedKey >= 0xE0){       /*Modificadores*/        
        ...
        ble.print(sumKey);
        ble.print("-00-");
        ble.println(pressedKey, HEX); //hay que hacer algo para poder enviar NKRO6 y así aprovechar todo el chunk de información
      }
